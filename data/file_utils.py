...
class FileUtils:
    ...
    def write_row_to_file(out_file_path, row_data):
        ...
        try:
            ...
            Msg.print_error(
                "ERROR [write_row_to_file]: could not write into " + out_file_path
            )
    ...
    def get_dir_list_in_directory(dir_path):
        try:
            ...
            Msg.print_error(
                "ERROR: issue in retrieving directory list within given directory "
                + dir_path
            )
            Msg.print_error(str(e))
    ...
    def get_files_in_directory(dir_path, is_sorted=False):
        try:
            ...
            Msg.print_error(
                "ERROR: issue in retrieving files within directory " + dir_path
            )
            Msg.print_error(str(e))
